  ...
  return (
    <main className="relative flex min-h-dvh items-center justify-center p-6 sm:p-8">
      ...
      <div className="relative w-full max-w-xl">
        <div className="relative border-4 border-black bg-[#fdf4dc] p-6 pb-8 shadow-[8px_8px_0_0_rgba(0,0,0,0.85)] sm:p-10 sm:shadow-[12px_12px_0_0_rgba(0,0,0,0.85)]">
          {/* title */}
            ...
            {careers.map((career, i) => (
              <li key={career.company} className={i > 0 ? 'mt-10' : ''}>
                <div className="text-center">
                  <span className={`inline-block ${i % 2 === 1 ? '-rotate-2' : 'rotate-2'} rounded-lg border-[3px] border-black bg-[#f6a9c9] px-3 py-0.5 font-righteous text-sm tracking-widest text-[#5d3fae] shadow-[2px_2px_0_0_#000] sm:shadow-[3px_3px_0_0_#000]`}>
                    {career.period}
                  </span>
